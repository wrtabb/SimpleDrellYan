...
void getUnfoldingHistograms()
{
	...
	hInvMassMatrix->GetXaxis()->SetTitle("m_{#mu#mu,true} [GeV]");
	hInvMassMatrix->GetYaxis()->SetTitle("m_{#mu#mu,obs} [GeV]");
	hInvMassMatrix->Draw("colz");
	c2->SaveAs("plots/invMassMatrixDressed_MuMu.png");
	...
	hInvMassDYLL->SetFillColor(kWhite);
	...
	c4->cd();
        ...
        hRatioReco->Draw("pe");
	c4->SaveAs("plots/invMassMatrixProjections_MuMu.png");
	...
	TCanvas*c5=new TCanvas("c5","",0,0,1000,1000);
        ...
        c5->SaveAs("plots/invMassResponseMatrix_MuMu.png");
